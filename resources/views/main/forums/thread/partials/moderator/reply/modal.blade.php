<button type="button" class="btn btn-outline-warning mx-1" data-toggle="modal" data-target="#moderatorReplyOptions-{{$reply->id}}">
    Moderator Options
</button>
<div class="modal fade" id="moderatorReplyOptions-{{$reply->id}}" tabindex="-1" role="dialog" aria-labelledby="moderatorReplyOptionstitle-{{$reply->id}}" aria-hidden="true">
